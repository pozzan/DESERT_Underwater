...
# Two nodes each with a a MFSK_WHOI_MM: public UWMPhy_modem module for each node,
...
#
#	+-----------------------+	                        +-----------------------+
#	| 7. UWCBR (tx or tx/rx)|                               | 7. UWCBR (rx or tx/rx)|
#	+-----------------------+	                        +-----------------------+
#	|       6. UWUDP        |                               |       6. UWUDP        |
#	+-----------------------+	                        +-----------------------+
...
if {$application == "duplex"} {
   ...
   if {$useminipck == "yes"} {
       set tf_name "stack1-mfsk_whoi_mm-duplex.tr"
   } else {
       set tf_name "stack1-mfsk_whoi_mm-duplex.tr" 
   }
   ...
   if {$useminipck == "yes"} {
       set tf_name "stack1-mfsk_whoi_mm-simplex.tr"
   } else {
       set tf_name "stack1-mfsk_whoi_mm-simplex.tr" 
   }
